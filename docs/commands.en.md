...
> 🔧 Commands: 51 | 🧠 Intent Types: 34 | See [README](../README.en.md)
...
# Default: reads from  期次-XX/00-产品需求/ (product requirements)
# Output:  Spec docs to 期次-XX/00-需求文档/
...
speccore analyze -I Q1                                    # Iteration req analysis (reads 00-产品需求/)
...
#   期次-Q1/
#     ├── 00-产品需求/          ← Product requirements (read-only, imported)
#     └── 00-需求文档/          ← Spec documents (generated by analyze)
#           ├── ANALYSIS.md     ← AI analysis report
#           ├── TECH.md         ← Technical design template
#           ├── TEST.md         ← Test plan template
#           ├── REVIEW.md       ← Code review checklist
#           ├── RISK.md         ← Risk assessment
#           ├── DEPS.md         ← Dependency list
#           └── MONITOR.md      ← Monitoring metrics
