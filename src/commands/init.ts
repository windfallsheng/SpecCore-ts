...
async function createToolIntegrations(projectRoot: string, toolFilter?: string): Promise<void> {
  const commands: [string, string, string][] = [
    ...
    ['spec-analyze', '需求分析: 期次=${1:Q1} 可选任务=${2:Task-001}', 'speccore analyze -I ${1:Q1} --task ${2:Task-001}'],
    ['spec-split', '拆分任务: 期次=${1:Q1} 责任人=${2|张三,李四,王五|}', 'speccore iteration split -i ${1:Q1} --owner ${2|张三,李四,王五|}'],
    ['spec-execute', '执行任务: 期次=${1:Q1} 任务=${2:Task-001} 类型=${3|feature,bugfix,research|}', 'speccore execute -i ${1:Q1} -t ${2:Task-001} --type ${3|feature,bugfix,research|} --force'],
    ...
    ['spec-dev', '智能级联: 期次=${1:Q1} ${2|,--auto|}', 'speccore dev -i ${1:Q1} ${2|,--auto|}'],
