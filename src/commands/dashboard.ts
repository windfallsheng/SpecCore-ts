...
<div class="header">
  ...
  <div class="header-right">
    ...
    <div class="phase-indicator"><div class="dot"></div><span>v${index.version || '1.0'} · ${index.lastUpdated || now}</span></div>
  </div>
...
function setTheme(t) {
  ...
  [statusChart, projectChart, resolvedChart].forEach(ch => {
    ...
    ch.options.plugins.legend && (ch.options.plugins.legend.labels.color = tc);
    ch.update();
  });
}
