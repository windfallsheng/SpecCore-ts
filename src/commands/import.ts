...
async function scanProject(projectPath: string, projectType: ProjectType): Promise<ScanResult> {
 ...
 * 递归扫描 API 端点
 */
async function scanApiEndpoints(srcDir: string): Promise<ApiEndpoint[]> {
