...
| 我是 | 只需要学 | 快速入口 |
| :--- | :--- | :--- |
| 🚀 **新人 / 全部** | 11 个命令（简洁模式） | [快速开始](docs/快速开始.md) |
| 💻 **开发工程师** | `init` `execute` `pr` `done` | [开发流](#-开发流) |
| 🔧 **维护者** | `config` `backup` `archive` | [管理命令](#-管理命令) |
| 🔬 **高级用户** | 79+ 个命令（全量模式） | `speccore init --full` |
...
| `speccore doc2spec` | `/spec-doc2spec` | Word 文档导入 |
...
| 🚀 [快速开始（简洁版）](docs/快速开始.md) | 11 个核心命令 → 安装 → 7 步流程 → 速查 |
| [全量命令参考](docs/命令参考.md) | 79+ 个命令完整参数（适合高级用户） |
