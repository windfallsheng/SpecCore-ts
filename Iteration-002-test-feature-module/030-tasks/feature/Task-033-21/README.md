...
| :--- | :--- | :--- | :--- |
| Task-033-21-app | app | 未分配 | 🔲 待开发 |
| Task-033-21-h5 | h5 | 未分配 | 🔲 待开发 |
| Task-033-21-miniapp | miniapp | 未分配 | 🔲 待开发 |
| Task-033-21-admin | admin | 未分配 | 🔲 待开发 |

## AI 执行时读取规则

运行 `speccore execute -t Task-033-21 --platform {端}` 时:
